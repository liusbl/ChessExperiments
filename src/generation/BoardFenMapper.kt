...
object BoardFenMapper {
    ...
    fun getBoard(fen: String): IndexBoard {
        ...
        if (!customFenPart.contains("L")) return IndexBoard(index, usualFenPart, move, false, CheckState.NONE, emptyList())
        ...
        return IndexBoard(index, usualFenPart, move, true, checkState, nextBoardIndexList)
    }
}
